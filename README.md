...
[![Build Status](https://gitlab.ebi.ac.uk/hca/ingest-exporter/badges/dev/pipeline.svg)](https://gitlab.ebi.ac.uk/hca/ingest-exporter/-/pipelines)
...
### How to run locally and hijaconectck a given environment
